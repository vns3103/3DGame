...
function start(){
	...
	RC.cameraArbre.position.x =-220;
	RC.cameraArbre.position.z =50;
	RC.cameraArbre.position.y =280;
	RC.cameraArbre.rotation.x =90*3.14/180.0;
	RC.cameraArbre.rotation.y =200*3.14/180.0;
	...
	*/
	RC.camera1.position.x =-220;
	RC.camera1.position.z =24;
	RC.camera1.position.y = 80;
	RC.camera1.rotation.x =90*3.14/180.0;

	RC.camera0.position.x =-220;
	RC.camera0.position.z =24;
	RC.camera0.position.y = -120;
	RC.camera0.rotation.x =90*3.14/180.0;

	RC.camera29.position.x =-214;
	RC.camera29.position.z =62;
	RC.camera29.position.y = -240;
	RC.camera29.rotation.x =90*3.14/180.0;


	RC.camera27.position.x =-30;
	RC.camera27.position.z =70;
	RC.camera27.position.y = -235;
	RC.camera27.rotation.x =90*3.14/180.0;
	RC.camera27.rotation.y =90*3.14/180;

	RC.camera23.position.x =-60;
	RC.camera23.position.z =140;
	RC.camera23.position.y = -20;
	RC.camera23.rotation.x =90*3.14/180.0;

	RC.camera23.rotation.y =170*3.14/180;

	RC.camera19.position.x =46;
	RC.camera19.position.z =150;
	RC.camera19.position.y = -270;
	RC.camera19.rotation.x =90*3.14/180.0;

	RC.camera17.position.x =90;
	RC.camera17.position.z =130;
	RC.camera17.position.y = -50;
	RC.camera17.rotation.x =90*3.14/180.0;
	RC.camera17.rotation.y =180*3.14/180;


	RC.camera13.position.x =110;
	RC.camera13.position.z =120;
	RC.camera13.position.y =130;
	RC.camera13.rotation.x =90*3.14/180.0;
	RC.camera13.rotation.y =180*3.14/180;

	RC.camera5.position.x =-140;
	RC.camera5.position.z =80;
	RC.camera5.position.y =280;
	RC.camera5.rotation.x =90*3.14/180.0;
	RC.camera5.rotation.y =-90*3.14/180;


	RC.camera8.position.x =-30;
	RC.camera8.position.z =150;
	RC.camera8.position.y =180;
	RC.camera8.rotation.x =90*3.14/180.0;
	RC.camera8.rotation.y =220*3.14/180;


	RC.camera11.position.x =60;
	RC.camera11.position.z =120;
	RC.camera11.position.y =100;
	RC.camera11.rotation.x =90*3.14/180.0;
	RC.camera11.rotation.y =220*3.14/180;
	...
	function render() { 
		...
		//console.log(carr.position.x+'x'+ carr.position.y +'y'+ carr.position.z+'z');

		var pos = NAV.findActive(carr.position.x,carr.position.y);

		if(true){
			if( pos == 3 || pos == 4){
				RC.renderer.render(RC.scene, RC.cameraArbre);
			}
			if( pos == 5 || pos == 6 || pos == 7){
				RC.renderer.render(RC.scene, RC.camera5);
			}
			if( pos == 8 || pos == 9 || pos == 10){
				RC.renderer.render(RC.scene, RC.camera8);
			}
			if( pos == 11 || pos == 12){
				RC.renderer.render(RC.scene, RC.camera11);
			}

			if( pos == 13 || pos == 14 || pos == 15){
				RC.renderer.render(RC.scene, RC.camera13);
			}

			if( pos == 16 || pos == 17 || pos == 18){
				RC.renderer.render(RC.scene, RC.camera17);
			}

			if( pos == 19 || pos == 20 ){
				RC.renderer.render(RC.scene, RC.camera19);
			}
			...
			if( pos == 23 || pos == 24 ){
				RC.renderer.render(RC.scene, RC.camera23);
			}
			if( pos == 27 || pos == 28 || pos == 26|| pos == 25){
				RC.renderer.render(RC.scene, RC.camera27);
			}

			if( pos == 29 || pos == 30 ){
				RC.renderer.render(RC.scene, RC.camera29);
			}

			if(pos == 0 ){
				RC.renderer.render(RC.scene, RC.camera0);
			}
			if(pos == 1 || pos == 2 ){
				RC.renderer.render(RC.scene, RC.camera1);
			}
		}
